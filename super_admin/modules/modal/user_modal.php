...
$sql = "SELECT user_type_id, name FROM tbl_user_types";
$result = mysqli_query($db, $sql) or die("Bad SQL: $sql");

$opt1 = "<select class='form-control' name='type' id = 'add_user_type' required>";
$opt1 .= "<option value='' selected hidden>Select Role</option>";
...
$opt2 = "<select class='form-control' name='type' id = 'edit_user_type' required>";
$opt2 .= "<option value='' selected hidden>Select Role</option>";
while ($row = mysqli_fetch_assoc($result)) {
    $opt2 .= "<option value='" . $row['user_type_id'] . "'>" . $row['name'] . "</option>";
}
$opt2 .= "</select>";
?>
