...
$opt1 = "<select class='btn btn-outline-success' name='type' id = 'barangay_search' required>";
    ...
    <div class="card border-0">
        ...
        <div class="card-body" style="overflow-x:auto;">
            <div class="d-flex" style="">
                <form id="form_select">
                    <?php echo $opt1; ?>
                    <select class="btn btn-outline-success" id="select_month" required>
                    ...
                    <select class="btn btn-outline-success" id="select_year" required>
                    ...
                    <button type="button" class="btn btn-primary" onclick="search()"><i class="fa fa-magnifying-glass"></i> Search</button>
                </form>
                <br><br>
            </div><br>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function search_table(value) {
            $("#populate_table tr").each(function() {
