...
<main class="content px-3 py-2">
    <div class="page-heading">
        <h3 class="">Beneficiary Announcements</h3>
    </div>
    <br>
    <div>
        <button onclick="add_activity()" data-toggle="modal" class="btn btn-primary" type="button"><i class="fa fa-plus"></i> Add Activity</button>
   <a href="announcement"><button class="btn btn-outline-dark" style="float:right;">Announcements</button></a>
    </div><br>
...
<?php include "modal/modal_announcement_news.php"; ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#myTable').DataTable({
            ajax: 'announcements_news/view', // API endpoint to fetch data
            columns: [{
                    data: [0],
        ...
        $('#form_udpate').submit(function(e) {
            ...
            let bene_id         = $('#edit_id').val()

            $.ajax({
                url: 'announcements_news/update',
                type: 'POST',
                data: {
                    description : description,
                    purpose     : purpose,
        ...
        $("#upload_form").on("submit", function(e) {
            ...
            if (files.length > 0) {
                ...
                $.ajax({
                    url: 'announcements_news/announcement_upload',
                    type: 'post',
                    data: fd,
                    contentType: false,
                    processData: false,
